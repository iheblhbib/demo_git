...
<div id="templatemo_top_wrapper">
	<div id="templatemo_top">
	  <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                <li><a href="profile2.php" class="selected"><img src="home-150499_1280.png" width="50" height="50" /></a></li>
				
                <li><a href="gestion_des_utilisateurs/index4.php">Gestion Utilisateurs</a>
...
<div id="templatemo_main_wrapper">
  <div id="templatemo_slider_wrapper">
    ...
    <div id="templatemo_main">
	  ...
	  <h2 align="center"> Gestion de Stock Magasin de l'ISSAT </h2>
    </div> <!-- end of main -->
